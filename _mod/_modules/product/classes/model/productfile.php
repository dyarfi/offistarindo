...
class Model_ProductFile extends Model_Database {
	...
	public function install () {
		...
		$sql	= 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
				...
				. 'INDEX (`product_id`, `name`, `allow_comment`, `status`) '
				. ') ENGINE=MYISAM';
	...
	public function load_by_filename ($file_name, $product_id = '') {
		if ($product_id != '') {
