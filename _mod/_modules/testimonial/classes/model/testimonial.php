...
class Model_Testimonial extends Model_Database {
	...
	public function delete ($id = '') {
		...
		$delete		= DB::delete('testimonial_content')->where('testimonial_id', '=', $id)->execute();
		return $result;
	}
	...
	public function find_detail($where_cond = '', $order_by = '', $limit = '', $offset = '') {		
		...
		foreach ($detail as $data) {			
			...
			unset($_data_vars[$i]['_model_vars'],
				  ...
				  $_data_vars[$i]['_db']);			
			// Get Language Detail			
			$detail_data = Model::factory('TestimonialContent')->find(array('testimonial_id'=>$data->id,'lang_id'=>Lang::_lang_id(I18n::lang())));
