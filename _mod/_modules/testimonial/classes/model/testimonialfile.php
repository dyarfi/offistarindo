...
class Model_TestimonialFile extends Model_Database {
	protected $table = 'testimonial_files'; 
	protected $tbl_name;
	...
	public function install () {
		...
		$sql	= 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
				...
				. 'INDEX (`testimonial_id`, `name`, `allow_comment`, `status`) '
				. ') ENGINE=MYISAM';
	...
	public function load_by_filename ($file_name, $testimonial_id = '') {
		if ($testimonial_id != '') {
	...
	public function load_by_group($id){
		...
		$where_cond	= array('testimonial_id'			=> $id);
	...
	public function find ($where_cond = '', $order_by = '', $limit = '', $offset = '') {
		...
		foreach ($rows as $row) {
			$object			= new Model_TestimonialFile;
