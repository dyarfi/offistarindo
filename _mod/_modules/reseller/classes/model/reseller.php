...
class Model_Reseller extends Model_Database {
	...
	public function delete ($id = '') {
		...
		$delete		= DB::delete('reseller_content')->where('reseller_id', '=', $id)->execute();
	...
	public function find_detail($where_cond = '', $order_by = '', $limit = '', $offset = '') {		
		...
		foreach ($detail as $data) {			
			...
			unset($_data_vars[$i]['_model_vars'],
				  ...
				  $_data_vars[$i]['_db']);			
			// Get Language Detail			
			$detail_data = Model::factory('ResellerContent')->find(array('reseller_id'=>$data->id,'lang_id'=>Lang::_lang_id(I18n::lang())));
	...
	public function set_order($type_id = '', $group = '', $action='') {
		$type = '';
