...
?>
		...
		<?php echo sprintf($errors['order'], 'Order'); ?>
			<div class="form_row">
				<label>Order</label>
				<input type="text" style="width:22px;" maxlength="3" data-url="<?php echo URL::site(ADMIN.$class_name.'/check_order');?>" name="order" class="required" id="order" value="<?php echo !empty($orders) ? $orders + 1 : $fields['order'];?>"/>				
			</div>
		<?php endif; ?>
