...
<form class="form_details" action="<?php echo URL::site(ADMIN.$class_name.'/edit/'.$listing->id); ?>" method="get">
		<div class="form_wrapper">
			
								
		<fieldset class="wrapper_fs"><legend>Title Product</legend>
			<div class="form_row">
				<label><?php echo i18n::get('title');?></label>
				<div class="form_fields"><?php echo ($listing->title) ? $listing->title : '-'; ?></div>
			</div>
			<div class="form_row">
				<label><?php echo i18n::get('status');?></label>
				<div class="form_fields"><?php echo ucfirst($listing->status);?></div>
			</div>				
			<div class="form_row">
				<label><?php echo i18n::get('category');?></label>
				<div class="form_fields">
				<?php 
				$subject = Model::factory('SolutionCategory')->find_detail(array('id'=>$listing->category_id));
				echo ($subject[0]->title) ? Text::limit_words($subject[0]->title,10) :''; 
		...
		<fieldset class="wrapper_fs"><legend>Detail Language</legend>
			...
			<?php 
				...
				foreach($language_data as $language):						
					...
					<div id="lang_<?php echo $prefix[$language->id]; ?>">
						...
						<div class="form_row">
							<div class="cd_left gray">Combination 1</div>
							<div class="cd_center">:</div>
							<div class="clear ls4"></div> 
							<div class="form_field"><?php echo $detail_data[$language->id]->combination1; ?></div>
						</div>
						<div class="form_row">
							<div class="cd_left gray">Combination 2</div>
							<div class="cd_center">:</div>
							<div class="clear ls4"></div> 
							<div class="form_field"><?php echo $detail_data[$language->id]->combination2; ?></div>
						</div>
						<div class="form_row">
							<div class="cd_left gray">Combination 3</div>
							<div class="cd_center">:</div>
							<div class="clear ls4"></div> 
							<div class="form_field"><?php echo $detail_data[$language->id]->combination3; ?></div>
						</div>
					</div>	
				<?php
					endif;
			...
			<div class="form_row">
				<label>Status</label>
				<div class="form_field"><?php echo ucfirst($listing->status); ?></div>
			</div>
			<div class="form_row">
				<label>Created</label>
				<div class="form_field"><?php echo ($listing->added != 0) ? date(Lib::config('site.date_format'), $listing->added) : '-'; ?></div>
			</div>
			<div class="form_row">
				<label>Last Modified</label>
				<div class="form_field"><?php echo ($listing->modified != 0) ? date(Lib::config('site.date_format'), $listing->modified) : '-'; ?></div>
			</div>
		</div>
		<div class="form_row">
