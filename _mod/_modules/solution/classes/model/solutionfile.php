...
class Model_SolutionFile extends Model_Database {
	...
	public function install () {
		...
		$sql	= 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
				...
				. 'INDEX (`solution_id`, `name`, `allow_comment`, `status`) '
				. ') ENGINE=MYISAM';
	...
	public function load_by_filename ($file_name, $solution_id = '') {
		if ($solution_id != '') {
