...
class Model_SolutionContent extends Model_Database {
	protected $table = 'solution_content'; 
	protected $tbl_name;
	...
	public function install () {
        ...
        $sql = 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
            ...
            .'`solution_id` INT(11) NULL , '
			.'`lang_id` TINYINT(3) NULL , '
            .'`subject` VARCHAR(255) NULL, '
			.'`text` TEXT NULL, '
			.'`combination1` TEXT NULL, '            
			.'`combination2` TEXT NULL, '
            .'`combination3` TEXT NULL '
            .') ENGINE=MYISAM';
	...
	public function add ($params = '') {
		...
		unset($this->_model_vars['id'],$params['id']);
	...
	public function find ($where_cond = '', $order_by = '', $limit = '', $offset = '') {
		...
		foreach ($rows as $row) {
			$object			= new Model_SolutionContent;
