...
class Model_NewsFilesFile extends Model_Database {
	protected $table = 'news_file_files'; 
	protected $tbl_name;
	...
	public function install () {
		...
		$sql	= 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
				...
				. 'INDEX (`news_id`, `name`, `allow_comment`, `status`) '
				. ') ENGINE=MYISAM';
	...
	public function load_by_filename ($file_name, $news_id = '') {
		if ($news_id != '') {
	...
	public function find ($where_cond = '', $order_by = '', $limit = '', $offset = '') {
		...
		foreach ($rows as $row) {
			$object			= new Model_NewsFilesFile;
