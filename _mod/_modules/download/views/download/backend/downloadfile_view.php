...
<form class="form_details" action="<?php echo URL::site(ADMIN.$class_name.'/edit/'.$file->id); ?>" method="get">
	<div class="form_wrapper">
		...
		<fieldset class="wrapper_fs"><legend>Title File</legend>
			<div class="form_row">
				<label><?php echo i18n::get('title');?></label>
				<div class="form_fields"><?php echo ($file->title) ? $file->title : '-'; ?></div>
			</div>
			...
			<div class="form_row">
				...
				<div class="form_fields"><?php echo ucfirst($file->status);?></div>
			</div>	
		</fieldset>
	...
	<div class="form_row">
		...
		<div class="form_fields">
			<?php 
			if (in_array($filesFile->file_type, $readable_mime)) : 
			?>
			<div id="file_<?php echo $filesFile->id; ?>">
				<?php if (substr($filesFile->file_type, 0, strlen('image/')) == 'image/') : ?>
				<?php
					$file_data	= pathinfo(URL::base().$upload_url.$filesFile->file_name);
	...
	<div class="form_row">
		<div class="form_field">
		<a class="download" title="Download" href="<?php echo URL::site(ADMIN.$class_name.'/download/'.base64_encode($upload_url.$filesFile->file_name));?>">
			<img src="<?php echo IMG; ?>admin/disk.png" alt="<?php echo $file->file_name; ?>" />
		</a>
		</div>
	</div>
