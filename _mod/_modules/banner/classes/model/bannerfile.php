...
class Model_BannerFile extends Model_Database {
	...
	public function install () {
		...
		$sql	= 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
				...
				. 'INDEX (`banner_id`, `name`, `allow_comment`, `status`) '
				. ') ENGINE=MYISAM';
	...
	public function load_by_filename ($file_name, $banner_id = '') {
		if ($banner_id != '') {
