...
<form class="form_details" action="<?php echo url::site(ADMIN.$class_name.'/edit/'.$banner->id); ?>" method="get">
		...
		<fieldset class="wrapper_fs"><legend>Title Banner</legend>
			<div class="form_row">
				...
				<div class="form_fields"><?php echo ($banner->title) ? $banner->title : '-'; ?></div>
			</div>
			<div class="form_row">
				<label><?php echo i18n::get('status');?></label>
				<div class="form_fields"><?php echo ucfirst($banner->status);?></div>
			</div>	
		</fieldset>
		<fieldset class="wrapper_fs"><legend>Detail Language</legend>
			...
			<div class="form_row">
				<label>Order</label>
				<div class="form_field"><?php echo $banner->order; ?></div>
			</div>
			<?php endif; ?>
