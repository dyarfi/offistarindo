...
$current_path = !empty($_current_path)
					? $_current_path
						: '../uploads/download_files/'; // relative path from filemanager folder to upload folder (with final /)
*/						
...
$current_path = '../uploads/download_files/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../uploads/download_files/thumb/'; // relative path from filemanager folder to thumbs folder (with final /)
 * 
 */
//
//print_r($upload_dir);
